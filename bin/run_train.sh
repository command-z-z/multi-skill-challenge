...
[[ -z $train_data_path ]] && train_data_path=${project_dir}/datasets/output/train.txt
[[ -z $valid_data_path ]] && valid_data_path=${project_dir}/datasets/output/dev.txt
output_dir=${project_dir}/output/train/$(date +%m%d_%H%M)  # output directory

model_type="uniLM"
# pretrained_model_path="unified_transformer-12L-cn-luge"
pretrained_model_path="./output/train/0718_1152/model_68000"
train_epochs=20
batch_size=8192
